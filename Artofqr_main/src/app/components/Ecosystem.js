...
import { BadgePercent, Globe, Image as ImageIcon, MapPinned, Megaphone, Search, ShoppingBag, Zap } from "lucide-react";
...
const techCategories = [
  {
    ...
    technologies: ["Keyword Research", "On-Page SEO", "Technical SEO", "Local SEO", "Monthly Reports"],
  ...
  },
  {
    ...
    technologies: ["Instagram", "Facebook", "LinkedIn", "YouTube", "Reel Marketing"],
  ...
  },
  {
    ...
    technologies: ["Landing Pages", "Business Websites", "Portfolio Sites", "Real Estate Sites", "E-Commerce Sites"],
...

  {
    ...
    technologies: ["Meta Ads", "Google Ads", "YouTube Ads", "Targeted Audience", "Lead Generation"],
  ...
  },
  {
    ...
    technologies: ["Profile Setup", "Optimization", "Review Support", "Photo Updates", "Maps Visibility"],
  ...
  },
  {
    ...
    technologies: ["Amazon", "Flipkart", "Meesho", "Product Listing", "Image Optimization"],
    ...
    <section className="relative min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 text-gray-900 dark:text-white overflow-hidden py-20 md:py-32">
      ...
      <div className="container mx-auto px-6 lg:px-20 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16 lg:mb-20">
          ...
          >
            Connected services that strengthen visibility, campaigns, reputation, and conversion.
          </motion.p>
        </div>
