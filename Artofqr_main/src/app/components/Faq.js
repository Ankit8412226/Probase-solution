          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Common questions about our digital marketing and website services.
              </p>
            </motion.div>
          ...
          <div className="lg:col-span-5">
            ...
            >
              <h3 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">
                Quick Requirement Snapshot
              </h3>
              <p className="text-gray-600 dark:text-gray-400 mb-8 text-sm">
                Share a few details and we&apos;ll understand what kind of growth support fits best.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all"
                    placeholder="SEO, social media, ads, website, GBP..."
                  />
                </div>
