...
const steps = [
  {
    ...
    subtitle: "Step 1",
    description: "We start by understanding your business category, offer, audience, and current digital gaps so the work is grounded in real goals.",
    icon: FileSearch,
  ...
  },
  {
    ...
    subtitle: "Step 2",
    description: "We decide which channels, assets, and priorities matter most, whether that is website improvement, SEO, social content, ads, or local profile work.",
    icon: Lightbulb,
  ...
  },
  {
    ...
    subtitle: "Step 3",
    description: "Messaging, design assets, campaign angles, and content style are shaped to match your brand and market position.",
    icon: Palette,
  ...
  },
  {
    title: "Build & Execute",
    subtitle: "Step 4",
    description: "We launch the agreed work across websites, campaigns, listings, social media, or supporting landing pages.",
    icon: Code,
  ...
  },
  {
    ...
    subtitle: "Step 5",
    description: "Performance, creative response, user experience, and content clarity are reviewed so we can improve what matters most.",
    icon: TestTube,
  ...
  },
  {
    ...
    subtitle: "Step 6",
    description: "We support rollout, publishing, and go-live readiness so your business looks polished when customers find you.",
    icon: Rocket,
  ...
  },
  {
    ...
    subtitle: "Step 7",
    description: "Digital growth is iterative, so we continue refining based on visibility, engagement, enquiry quality, and business feedback.",
    icon: Wrench,
    ...
    <section className="relative min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900 text-gray-900 dark:text-white overflow-hidden py-16 md:py-32">
      <div className="container mx-auto px-4 md:px-6 lg:px-20">
        ...
        <div className="text-left md:text-center mb-12 md:mb-32">
          ...
          >
            A structured 7-step process that keeps strategy, execution, and improvement aligned with your business goals.
          </motion.p>
        </div>
