                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    >
                        <div>
                            ...
                            >
                                Featured Client Focus
                            </motion.span>
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white leading-tight">
                                Dental<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600"> Growth</span>
                            </h2>
                            <h3 className="text-xl md:text-2xl font-medium text-slate-600 dark:text-slate-300 mt-2">
                                Healthcare Lead Generation & Local Visibility
                            </h3>
                        </div>

                        <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-xl">
                            We help clinic and healthcare brands improve discoverability through Google Business Profile optimization, social media branding, patient awareness content, and local search support designed to build trust and drive enquiries.
                        </p>
                        ...
                        <div className="flex gap-6 pt-4 border-t border-slate-200 dark:border-slate-800">
                            <div className="flex flex-col">
                                <span className="text-3xl font-bold text-slate-900 dark:text-white">Local</span>
                                <span className="text-sm text-slate-500 uppercase tracking-wide">Search Visibility</span>
                            </div>
                            <div className="flex flex-col">
                                <span className="text-3xl font-bold text-slate-900 dark:text-white">Lead</span>
                                <span className="text-sm text-slate-500 uppercase tracking-wide">Generation Focus</span>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        >
                            <div className="aspect-[4/3] relative">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                                    <span className="text-white font-medium text-lg">Request a tailored growth plan &rarr;</span>
                                </div>
                            </div>
                        </motion.div>
