        ...
        <div className="text-left sm:text-center mb-12 lg:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">
            <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent dark:from-purple-400 dark:to-blue-300">
              Need better digital growth?
            </span>{" "}
            <span className="text-gray-600 dark:text-gray-300">
              Let&apos;s <br className="hidden sm:block"/> plan it together
            </span>
          </h2>

          <p className="text-gray-600 dark:text-gray-400 max-w-xl sm:mx-auto">
            Share your business goals, campaign needs, or website requirements and we&apos;ll get back with the right next step.
          </p>
        </div>
          ...
          >
            ...
            <div className="flex items-start gap-4 lg:gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm lg:text-base">{companyProfile.phones.join(" | ")}</p>
              </div>
            </div>
